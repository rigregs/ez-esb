...
@ComponentScan
@EnableJpaRepositories(basePackages = "com.opnitech.esb.persistence.jpa")
@EnableElasticsearchRepositories(basePackages = "com.opnitech.esb.persistence.elastic")
@Profile("default")
